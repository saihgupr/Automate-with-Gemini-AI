...
Turn natural language into Home Assistant automations using Google's Gemini AI. Just describe what you want in plain English – no YAML knowledge required! Automations are automatically added to your automations.yaml and reloaded.
